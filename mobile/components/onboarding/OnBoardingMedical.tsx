...
export default function OnBoardingMedical({ onNext }: OnBoardingMedicalProps) {
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          {/* Title */}
          <Text style={styles.title}>Set Medical{"\n"}Appointments</Text>

          {/* Description */}
          <Text style={styles.description}>
            Schedule appointments or set daily medicine schedule on your
            patient's calendar to remind them
          </Text>

          {/* Next Button */}
          <View style={styles.buttonRow}>
            <TouchableOpacity style={styles.nextButton} activeOpacity={0.8} onPress={onNext}>
