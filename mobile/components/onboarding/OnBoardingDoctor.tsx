...
// ─── Component ─────────────────────────────────────────────
interface OnBoardingDoctorProps {
  onNext?: () => void;
}

export default function OnBoardingDoctor({ onNext }: OnBoardingDoctorProps) {
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.description}>
            Connecting with your Health Provider and Caregiver allows them to
            set your medication schedule and dosage{"\n"}automatically
          </Text>
...
const styles = StyleSheet.create({
  ...
  buttonRow: {
    flexDirection: "row",
    justifyContent: "flex-end",
    paddingTop: scaleH(isSmallDevice ? 10 : 5),
  },
  startButton: {
    flexDirection: "row",
    alignItems: "center",
