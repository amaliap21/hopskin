...
// ─── Component ─────────────────────────────────────────────
interface OnBoardingRealTimeProps {
  onNext?: () => void;
}

export default function OnBoardingRealTime({ onNext }: OnBoardingRealTimeProps) {
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.imageContainer}>
          <Image
            source={require("../../assets/realtime.png")}
        ...
        <View style={styles.contentContainer}>
          {/* Title */}
          <Text style={styles.title}>Real-time{"\n"}Alerts</Text>

          {/* Description */}
          <Text style={styles.description}>
            If your relative misses a dose window, your device will notify you
            so you can remind them immediately
          </Text>
