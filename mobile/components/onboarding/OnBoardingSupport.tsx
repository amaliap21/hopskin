...
export default function OnBoardingSupport({ onNext }: OnBoardingSupportProps) {
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          {/* Title */}
          <Text style={styles.title}>Be their{"\n"}support system</Text>

          {/* Description */}
          <Text style={styles.description}>
            Enter your relative's Patient ID to{"\n"}request access to their
            therapy calendar, monitor therapy{"\n"}progress, and step in when
            they need you most
          </Text>
