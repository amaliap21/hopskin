...
// ─── Component ─────────────────────────────────────────────
interface OnBoardingDoseProps {
  onNext?: () => void;
}

export default function OnBoardingDose({ onNext }: OnBoardingDoseProps) {
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.description}>
            Orbi uses your camera to detect your medicine and ensure you take it
            on time. Please allow camera and notification access to keep your
            therapy on track
          </Text>
